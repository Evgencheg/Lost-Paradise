...
nt-ClothingOuterGeCorporateJacket = Фирменная куртка Экспортионной корпорации
    .desc = Уютная куdртка с логотипом Экспортионной корпорацииё, напечатанным на спине. Товары, приобретенные на станциях, имеют коэффициент прочности, равный... семи?
